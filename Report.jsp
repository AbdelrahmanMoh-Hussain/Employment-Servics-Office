...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <userParameter name="BRITH" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL APPLICANT2.SSN, 
APPLICANT2.LNAME, APPLICANT2.SALARY, APPLICANT2.BIRTHDATE
FROM APPLICANT2 
Where birthdate <= :brith;]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_SSN">
        <displayInfo x="1.12097" y="1.94995" width="1.75818" height="0.61963"
        />
        <dataItem name="SSN" oracleDatatype="number" columnOrder="11"
         width="22" defaultWidth="120000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Ssn">
          <dataDescriptor expression="APPLICANT2.SSN"
           descriptiveExpression="SSN" order="1" oracleDatatype="number"
           width="22" precision="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <summary name="AvgSALARYPerSSN" source="SALARY" function="average"
         width="22" precision="6" reset="G_SSN" compute="report"
         defaultWidth="80000" defaultHeight="10000" columnFlags="520"
      ...
      <group name="G_LNAME">
        ...
        />
        <dataItem name="LNAME" datatype="vchar2" columnOrder="12"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Lname">
          <dataDescriptor expression="APPLICANT2.LNAME"
           descriptiveExpression="LNAME" order="2" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SALARY" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="80000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Salary">
          <dataDescriptor expression="APPLICANT2.SALARY"
           descriptiveExpression="SALARY" order="3" oracleDatatype="number"
        ...
        <dataItem name="BIRTHDATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Birthdate">
          <dataDescriptor expression="APPLICANT2.BIRTHDATE"
           descriptiveExpression="BIRTHDATE" order="4" oracleDatatype="date"
           width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    ...
    <summary name="AvgSALARYPerReport" source="SALARY" function="average"
     width="22" precision="6" reset="report" compute="report"
  ...
  <section name="main">
    <body>
      <frame name="M_G_SSN_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="4.06250" height="0.93750"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <repeatingFrame name="R_G_SSN" source="G_SSN" printDirection="down"
         minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="0.00000" width="4.06250"
           height="0.75000"/>
          <generalLayout verticalElasticity="variable"/>
          <visualSettings fillPattern="transparent"
          ...
          <field name="F_SSN" source="SSN" minWidowLines="1" spacing="0"
           alignment="start">
            ...
            />
            <geometryInfo x="0.31250" y="0.00000" width="1.81250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
          </field>
          <frame name="M_G_LNAME_GRPFR">
            <geometryInfo x="0.00000" y="0.18750" width="4.06250"
             height="0.56250"/>
            <generalLayout verticalElasticity="variable"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="r100g100b100"/>
            <repeatingFrame name="R_G_LNAME" source="G_LNAME"
             printDirection="down" minWidowRecords="1" columnMode="no">
              ...
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="TableCell"/>
              <field name="F_LNAME" source="LNAME" minWidowLines="1"
              ...
              <field name="F_SALARY" source="SALARY" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="1.50000" y="0.37500" width="1.18750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_BIRTHDATE" source="BIRTHDATE" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="2.68750" y="0.37500" width="1.37500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </repeatingFrame>
            <frame name="M_G_LNAME_FTR">
              <geometryInfo x="0.00000" y="0.56250" width="4.06250"
               height="0.18750"/>
              <advancedLayout printObjectOnPage="lastPage"
               basePrintingOn="anchoringObject"/>
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="Totals"/>
              <field name="F_AvgSALARYPerSSN" source="AvgSALARYPerSSN"
               minWidowLines="1" spacing="0" alignment="start">
                <font face="helvetica" size="10" bold="yes"/>
                <geometryInfo x="1.50000" y="0.56250" width="1.18750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
            ...
            <frame name="M_G_LNAME_HDR">
              ...
              <text name="B_SALARY" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="1.50000" y="0.18750" width="1.18750"
                 height="0.18750"/>
              ...
              <text name="B_BIRTHDATE" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="2.68750" y="0.18750" width="1.37500"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="TableHeading"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
        ...
        <frame name="M_G_SSN_FTR">
          <geometryInfo x="0.00000" y="0.75000" width="4.06250"
           height="0.18750"/>
          <advancedLayout printObjectOnPage="lastPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
          ...
          <field name="F_AvgSALARYPerReport" source="AvgSALARYPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="0.62500" y="0.75000" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <visualSettings fillBackgroundColor="Totals"/>
          </field>
          <text name="B_AvgSALARYPerReport" minWidowLines="1">
            <textSettings spacing="0"/>
...
<rw:dataArea id="MGSSNGRPFR70">
<rw:foreach id="RGSSN701" src="G_SSN">
<!-- Start GetGroupHeader/n --> <table class="OraTable">
 <caption class="OraHeader">  <br>Ssn <rw:field id="F_SSN" src="SSN" breakLevel="RGSSN701" breakValue="&nbsp;"> F_SSN </rw:field><br>
 </caption>
<!-- End GetGroupHeader/n -->   <tr>
    ...
    <table class="OraTable" summary="">
     ...
     <thead>
      <tr>
       <th <rw:id id="HBLNAME70" asArray="no"/> class="OraColumnHeader"> Lname </th>
       <th <rw:id id="HBSALARY70" asArray="no"/> class="OraColumnHeader"> Salary </th>
       <th <rw:id id="HBBIRTHDATE70" asArray="no"/> class="OraColumnHeader"> Birthdate </th>
      </tr>
     </thead>
     <!-- Body -->
     <tbody>
      <rw:foreach id="RGLNAME701" src="G_LNAME">
       <tr>
        <td <rw:headers id="HFLNAME70" src="HBLNAME70"/> class="OraCellText"><rw:field id="FLNAME70" src="LNAME" nullValue="&nbsp;"> F_LNAME </rw:field></td>
        <td <rw:headers id="HFSALARY70" src="HBSALARY70"/> class="OraCellNumber"><rw:field id="FSALARY70" src="SALARY" nullValue="&nbsp;"> F_SALARY </rw:field></td>
        <td <rw:headers id="HFBIRTHDATE70" src="HBBIRTHDATE70"/> class="OraCellText"><rw:field id="FBIRTHDATE70" src="BIRTHDATE" nullValue="&nbsp;"> F_BIRTHDATE </rw:field></td>
       </tr>
      </rw:foreach>
     </tbody>
     <tr>
      ...
      <th class="OraTotalText"> &nbsp; </th>
      <td <rw:headers id="HFAvgSALARYPerSSN70" src="HBSALARY70"/> class="OraTotalNumber">Average: <rw:field id="FAvgSALARYPerSSN70" src="AvgSALARYPerSSN" nullValue="&nbsp;"> F_AvgSALARYPerSSN </rw:field></td>
      <th class="OraTotalText"> &nbsp; </th>
     </tr>
     <tr>
     </tr>
...
<table class="OraTable" summary="">
 <tr>
  <th class="OraTotalNumber"> Average: <rw:field id="F_AvgSALARYPerReport" src="AvgSALARYPerReport" nullValue="&nbsp;"> F_AvgSALARYPerReport </rw:field></th>
 </tr>
</table>
</rw:dataArea> <!-- id="MGSSNGRPFR70" -->
